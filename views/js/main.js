...
var pizzaElementGenerator = function(i) {
  ...
  pizzaDescriptionContainer.classList.add("col-md-7");
  pizzaDescriptionContainer.classList.add("col-md-8");
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
      var dx = determineDx(document.querySelectorAll(".randomPizzaContainer")[0], size);  //jf lets pull all of this out of the loop
      console.log('dx ='+dx);
      var newwidth = (document.querySelectorAll(".randomPizzaContainer")[0].offsetWidth + dx) + 'px';   //jf lets pull all of this out of the loop
      console.log('newwidth ='+newwidth);


    for (var i = 0; i < document.querySelectorAll(".randomPizzaContainer").length; i++) {
    //jf  var dx = determineDx(document.querySelectorAll(".randomPizzaContainer")[i], size);
    //jf  console.log('dx ='+dx);
    //jf  var newwidth = (document.querySelectorAll(".randomPizzaContainer")[i].offsetWidth + dx) + 'px';
    //jf  console.log('newwidth ='+newwidth);
...
function updatePositions() {
  ...
  var phasedata = [];                                     //jf added vaiable
  for (var i = 0; i < 5; i++) {
    phasedata[i] = Math.sin((document.body.scrollTop / 1250) + (i % 5));
//jf    console.log('phasedata['+i+']= '+phasedata[i]);
  }
  for (var i = 0; i < items.length; i++) {
 //jf   var phase = Math.sin((document.body.scrollTop / 1250) + (i % 5));
  //jf  console.log('phase ='+phase+' i ='+i % 5); //jf test point

  //jf  items[i].style.left = items[i].basicLeft + 100 * phase + 'px';
    items[i].style.left = items[i].basicLeft + 100 * phasedata[i % 5] + 'px';
